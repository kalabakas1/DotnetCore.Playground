...
namespace Playground.Api.Client.Model
{
    ...
    public partial class Configuration :  IEquatable<Configuration>, IValidatableObject
    {
        ...
        public Configuration(Guid id = default(Guid), string name = default(string), DateTime createdOn = default(DateTime), int retries = default(int), int sleepInMills = default(int), int healthCheckCount = default(int))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for Configuration and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (createdOn == null)
            {
                throw new InvalidDataException("createdOn is a required property for Configuration and cannot be null");
            }
            else
            {
